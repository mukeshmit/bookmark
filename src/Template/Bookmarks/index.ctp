    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
				...
				?>
				<th scope="col"><?= $this->Form->input('q',['label'=>'search']) ?></th>
                <th scope="col"><?= $this->Form->input('title',['label'=>'title']) ?></th>
                <th scope="col"></th>
                <th scope="col"></th>
                <th scope="col"><?= $this->Form->button('Filter', ['type' => 'submit']) ?></th>
                <th scope="col" class="actions"><?= $this->Html->link('Reset', ['action' => 'index']) ?></th>
				<?php
